      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center lg:me-auto 2xl:mx-auto 2xl:max-w-5xl">
        <div className="space-y-8">
          ...
          <div className="relative">
            <div className="from-primary/30 to-accent/30 absolute inset-0 bg-gradient-to-r blur-3xl" />
            <h1 className="relative pb-2 text-4xl font-bold tracking-tight md:text-6xl 2xl:text-7xl">
              <span className="block">
                Hi, I&apos;m <span className="z-99 text-white">Raihan Jami Khan</span>
              </span>
              <span className="mt-4 block text-2xl text-white lg:text-3xl">
